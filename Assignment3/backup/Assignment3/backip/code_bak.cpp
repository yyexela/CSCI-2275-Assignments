...
class WordAnalysis{
	...
	void fillStopWords(ifstream &ifs){
...
int main(int argc, char *argv[]){
	...
	wordAnalysis.fillStopWords(ifs);
	if(DEBUG)cout<<"#"<<endl;
	wordAnalysis.buildWords(ifs);
	if(DEBUG)cout<<"#"<<endl;
	//wordAnalysis.printWords();
	if(DEBUG)cout<<"#"<<endl;
	wordAnalysis.printTop();
	cout<<"#"<<endl;
	wordAnalysis.printBottom();
	cout<<"#"<<endl;
